...
void cyrus_beakk(double x0,double y0,double x1,double y1)
{
    // glPointSize(3);
...
void cyrus_beak(double x0,double y0,double x1,double y1)
{
    ...
    if(tlMin<teMax){
        ...
        {   
            printf("\n1st polygon\n");
            if((P0.first==-150 and P1.first==150) || (P1.first==-150 and P0.first==150))
            {
                printf("%.1lf %.1lf === %.1lf %.1lf\n",ar[0].x,ar[0].y,ar[1].x,ar[1].y);
                printf("%.1lf %.1lf === %.1lf %.1lf\n",ar[4].x,ar[4].y,ar[3].x,ar[3].y);
                printf("\n2nd polygon\n");
                printf("%.1lf %.1lf === %.1lf %.1lf\n",ar[1].x,ar[1].y,ar[2].x,ar[2].y);
                printf("%.1lf %.1lf === %.1lf %.1lf\n",ar[4].x,ar[4].y,ar[5].x,ar[5].y);
            }

            else if((P0.second==-150 and P1.second==150) || (P1.second==-150 and P0.second==150))
            {
                // if(print_flag)
                // {
                //     for(int i=0;i<6;i++)
            ...
            else if((P0.second==-150 and P1.first==150) || (P0.first==150 and P1.second==-150))
            {
                if(print_flag)
                {
                    for(int i=0;i<6;i++)
                ...
                printf("%.1lf %.1lf === %.1lf %.1lf === %.1lf %.1lf\n",ar[2].x,ar[2].y,ar[3].x,ar[3].y,ar[4].x,ar[4].y);
                
                printf("\n2nd polygon\n");
                // printf("%lf %lf  ---->%lf %lf\n",ar[1].x,ar[1].y,ar[2].x,ar[2].y);
                printf("%.1lf %.1lf === %.1lf %.1lf === %.1lf %.1lf === %lf %lf === %lf %lf\n",ar[0].x,ar[0].y,ar[1].x,ar[1].y,ar[5].x,ar[5].y,ar[4].x,ar[4].y,ar[2].x,ar[2].y);
            }
            else if((P0.second==-150 and P1.first==-150) || (P0.first==-150 and P1.second==-150))
            {
                if(print_flag)
                ...
                printf("%.1lf %.1lf === %.1lf %.1lf === %.1lf %.1lf\n",ar[0].x,ar[0].y,ar[1].x,ar[1].y,ar[3].x,ar[3].y);
                
                printf("\n2nd polygon\n");
                // printf("%lf %lf  ---->%lf %lf\n",ar[1].x,ar[1].y,ar[2].x,ar[2].y);
                printf("%.1lf %.1lf === %.1lf %.1lf === %.1lf %.1lf === %.1lf %.1lf === %.1lf %.1lf\n",ar[1].x,ar[1].y,ar[2].x,ar[2].y,ar[5].x,ar[5].y,ar[4].x,ar[4].y,ar[3].x,ar[3].y);
            }
            else if((P0.second==150 and P1.first==150) || (P0.first==150 and P1.second==150))
            {
                if(print_flag)
                ...
                printf("%.1lf %.1lf === %.1lf %.1lf === %.1lf %.1lf\n",ar[2].x,ar[2].y,ar[4].x,ar[4].y,ar[5].x,ar[5].y);
                
                printf("\n2nd polygon\n");
                // printf("%lf %lf  ---->%lf %lf\n",ar[1].x,ar[1].y,ar[2].x,ar[2].y);
                printf("%.1lf %.1lf === %.1lf %.1lf === %.1lf %.1lf === %.1lf %.1lf === %.1lf %.1lf\n",ar[0].x,ar[0].y,ar[1].x,ar[1].y,ar[2].x,ar[2].y,ar[4].x,ar[4].y,ar[3].x,ar[3].y);
            }
            else if((P0.second==150 and P1.first==-150) || (P0.first==-150 and P1.second==150))
            {
                if(print_flag)
                ...
                printf("%.1lf %.1lf === %.1lf %.1lf === %.1lf %.1lf\n",ar[1].x,ar[1].y,ar[2].x,ar[2].y,ar[3].x,ar[3].y);
                
                printf("\n2nd polygon\n");
                // printf("%lf %lf  ---->%lf %lf\n",ar[1].x,ar[1].y,ar[2].x,ar[2].y);
                printf("%.1lf %.1lf === %.1lf %.1lf === %.1lf %.1lf === %.1lf %.1lf === %lf %lf\n",ar[0].x,ar[0].y,ar[1].x,ar[1].y,ar[3].x,ar[3].y,ar[4].x,ar[4].y,ar[5].x,ar[5].y);
            }
        ...
        if(P0.first==x0 and P0.second==y0)
        {
            if(P1.first==x1 and P1.second==y1)
            {
                if(print_flag)
                {
                    printf("fully accepted\n");
        ...
        else if(P1.first==x1 and P1.second==y1)
        {
            if(P0.first==x0 and P0.second==y0)
            {
                if(print_flag)
